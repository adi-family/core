...
// packages/worker/templates/2025-10-18-01/worker-scripts/upload-evaluation-results.ts
...
var apiClient = new ApiClient(process.env.API_BASE_URL, process.env.API_TOKEN);
