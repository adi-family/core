...
// packages/worker/templates/2025-10-18-01/worker-scripts/shared/clarification-check.ts
...
// packages/worker/templates/2025-10-18-01/worker-scripts/codex-pipeline.ts
...
async function main() {
  ...
  try {
    ...
    logger2.info("\u2705 Codex pipeline completed successfully");
    process.exit(0);
  } catch (error) {
