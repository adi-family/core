...
// packages/worker/templates/2025-10-18-01/worker-scripts/shared/completion-check.ts
...
// packages/worker/templates/2025-10-18-01/worker-scripts/shared/env-validator.ts
...
// packages/worker/templates/2025-10-18-01/worker-scripts/claude-pipeline.ts
import { mkdir, readdir as readdir2, writeFile } from "fs/promises";
import { promisify as promisify2 } from "util";
import { exec as execCallback2 } from "child_process";
import { basename } from "path";

// packages/worker/templates/2025-10-18-01/worker-scripts/node_modules/@anthropic-ai/claude-agent-sdk/sdk.mjs
...
// packages/worker/templates/2025-10-18-01/worker-scripts/push-to-file-spaces.ts
import { exec as execCallback } from "child_process";
import { promisify } from "util";
import { readdir } from "fs/promises";

// packages/shared/gitlab-api-client.ts
...
var logger2 = createLogger({ namespace: "push-to-file-spaces" });
...
`;
    ...
    await writeFile("../results/implementation-usage.json", JSON.stringify(implementationUsage, null, 2), "utf-8");
...
${task.description || ""}`;
    const { output, errors, cost, iterations } = await executeClaudeAgent(prompt, "..", { ANTHROPIC_API_KEY: env.ANTHROPIC_API_KEY }, workspaces);
