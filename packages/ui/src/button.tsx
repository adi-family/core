      ...
      <button
        ...
        className={cn(
          ...
          disabled && "cursor-not-allowed",
          {
            ...
            'border border-neutral-600/50 bg-neutral-700/40 backdrop-blur-sm shadow-sm focus-visible:ring-gray-400 text-gray-100': variant === 'outline',
          ...
          !disabled && !loading && {
            ...
            'hover:bg-neutral-700/60 hover:border-neutral-500 hover:shadow': variant === 'outline',
