    ...
    return (
      <span
        ...
        className={cn(
          ...
          {
            'bg-gray-100/80 text-gray-700 border-gray-300 hover:bg-gray-200/80': variant === 'default',
            ...
            'bg-gray-100/80 text-gray-700 border-gray-300 hover:bg-gray-200/80': variant === 'gray',
          },
          className
        )}
        {...props}
